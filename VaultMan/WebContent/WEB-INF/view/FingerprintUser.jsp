				...
				<table cellpadding="0" cellspacing="0" border="0" id="fingerpringList" class="newdataList" width="100%">
					...
					<c:forEach items="${fingerprintuserList}" var="Item">
						<tr>
							...
							<td>${Item.userType}<input type="hidden" name="type" value="${Item.userType}" /></td>
							<td>${Item.fingerAmount}<input type="hidden" name="encrykeyamount" value="${Item.fingerAmount}" /></td>
							<td>
