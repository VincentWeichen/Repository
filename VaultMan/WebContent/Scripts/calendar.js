...
Calendar.dayMouseDblClick = function(ev) {
    ...
    if (Calendar.is_ie) {
        document.activeElement.value = ''; /*document.selection.empty();*/
    }
};
...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Switch The Frist Day Of A Week";
Calendar._TT["PREV_YEAR"] = "Select The Previous Year";
Calendar._TT["PREV_MONTH"] = "Select The Previous Month";
Calendar._TT["GO_TODAY"] = "Select Tody";
Calendar._TT["NEXT_MONTH"] = "Select The Next Month";
Calendar._TT["NEXT_YEAR"] = "Select The Next Year";
Calendar._TT["SEL_DATE"] = "Select Date";
Calendar._TT["DRAG_TO_MOVE"] = "Daggle";
Calendar._TT["PART_TODAY"] = " (Today)";
Calendar._TT["MON_FIRST"] = "Set Monday To The Frist Day Of A Week";
Calendar._TT["SUN_FIRST"] = "Set Sunday To The First Day Of A Week";
Calendar._TT["CLOSE"] = "Close";
Calendar._TT["TODAY"] = "Selete Today";
